...
class Value {
  public:
    ...
    [[nodiscard]] bool
        get_bool(bool default_val = false) const noexcept;
    [[nodiscard]] long long
        get_integer(long long default_val = 0) const noexcept;
    [[nodiscard]] double
        get_double(double default_val = 0.0) const noexcept;
    [[nodiscard]] std::string_view
        get_string(std::string_view default_val = "") const noexcept;
    ...
    // ── Iterators & Views ──
    [[nodiscard]] Result<views::Array>
        as_array() const noexcept;
    [[nodiscard]] Result<views::Object>
        as_object() const noexcept;
    [[nodiscard]] views::Array
        get_array() const noexcept;
    [[nodiscard]] views::Object
  ...
  private:
    ...
    [[nodiscard]] static Value
        fromInternal(const allocators::Storage* storage, const JsonValue& v) noexcept;
    [[nodiscard]] static Value
        createNull(const allocators::Storage* storage) noexcept;
};
...
template <>
struct tuple_element<0, zuu::models::views::Member> {
    using type = std::string_view;
};

template <>
struct tuple_element<1, zuu::models::views::Member> {
    using type = zuu::models::Value;
};
} // namespace std